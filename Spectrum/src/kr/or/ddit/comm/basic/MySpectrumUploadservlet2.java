...
@WebServlet("/mySpectrumUpload2")
//아래 어노테이션은 반드시 선언해야 함. 또는 톰캣 속성값(allowCasulaMultipartParsing=true)을 설정해야 함.
@MultipartConfig(fileSizeThreshold = 1024*1024*6, maxFileSize=1024*1224*80, maxRequestSize=1024*1024*100)
public class MySpectrumUploadservlet2 extends HttpServlet{
