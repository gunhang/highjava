      ...
      <form action="insert.do" method="post" name="frm"
         ...
         <div class="form-group">
            ...
            <div class="flex al-it-ce">
               ...
               <span id="checkId" class="checkText"></span>
            </div>
         </div>
         ...
         <div class="form-group">
            <label for="regno" class="control-label col-sm-2">주민번호 뒷자리</label>
            <div class="flex al-it-ce">
               <div class="col-sm-3">
                  <input type="text" class="form-control" id="regno"
                     placeholder="숫자7자" name="memberRegno">
               </div>
               <span id="spRegno" class="checkText"></span>
            </div>
         </div>
            ...
            <div class="flex al-it-ce">
               <div class="col-sm-3">
                  <input type="text" class="form-control" id="phoneNum"
                     name="memberPhonenum" placeholder="010-0000-0000">
               </div>
            ...
            <div class="flex al-it-ce">
               <div class="col-sm-3">
                  <input type="text" class="form-control" id="mail"
                     name="memberMail" placeholder="abc@abc">
               </div>
            ...
            <div class="flex al-it-ce">
               <div class="col-sm-3">
                  한글,영문 대소문자,숫자(1~8자) <input type="text" class="form-control"
                     id="nickname" name="memberNickName2" placeholder="닉네임을 입력하세요">
               </div>
         ...
         <div>
            <input type="submit" class="btn btn-primary" value="회원등록"
               onclick="joinsuccess()"> <input type='reset'
