...
<script src="https://kit.fontawesome.com/ff142f0d18.js"
   crossorigin="anonymous"></script>
<link rel="stylesheet"
...
<body>
   ...
   <div class="container">
      ...
      <form action="<%=request.getContextPath()%>/myPageUpdate.do"
         method="post">
            ...
            <div class="flex al-it-ce">
               <div class="col-sm-3">
                  <input type="text" class="form-control" id="name"
                     name="memberName" value="<%=mv.getMemberName()%>">
               </div>
               <span id="checkName" class="checkText"></span>
            </div>
         </div>

         <div class="form-group">
            <label for="pass" class="control-label col-sm-2">비밀번호</label>
            <div>영어 대소문자,숫자(4~12자)</div>
            ...
            <div class="flex al-it-ce">
               ...
               <span id="checkPass1" class="checkText"></span>
            </div>
         </div>
         ...
         <div class="form-group">
            ...
            <div class="flex al-it-ce">
               ...
               <span id="checkPass2" class="checkText"></span>
            </div>
         </div>
            ...
            <div class="flex al-it-ce">
               <div class="col-sm-3">
                  <input type="date" class="form-control" id="birth"
                     name="memberBirth" value="<%=mv.getMemberBirth()%>">
               </div>
               <span id="sp" class="checkText"></span>
            </div>
         </div>
            ...
            <div class="flex al-it-ce">
               <div class="col-sm-3">
                  <input type="text" class="form-control" id="phoneNum"
                     name="memberPhonenum" value="<%=mv.getMemberPhonenum()%>">
               </div>
               <span id="spPhoneNum" class="checkText"></span>
            </div>
         </div>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-3">
               <input type="text" class="form-control" id="sample6_postcode"
                  name="memberZipcode" value="<%=mv.getMemberZipcode()%>">
            </div>
         </div>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-3">
               <input type="text" class="form-control" id="sample6_address"
                  name="memberAddr3" value="<%=mv.getMemberAddr1()%>">
            </div>
            <span class="sp"></span>
         </div>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-3">
               <input type="text" class="form-control" id="sample6_detailAddress"
                  name="memberAddr4" value="<%=mv.getMemberAddr2()%>">
            </div>
            <span class="sp"></span>
         </div>
            ...
            <div class="flex al-it-ce">
               <div class="col-sm-3">
                  <input type="text" class="form-control" id="mail"
                     name="memberMail" value="<%=mv.getMemberMail()%>">
               </div>
               <span id="checkMail" class="checkText"></span>
         ...
         <div class="form-group">
            ...
            <div class="flex al-it-ce">
               <div class="col-sm-3">
                  한글,영문 대소문자,숫자(1~8자) <input type="text" class="form-control"
                     id="nickname" name="memberNickName"
                     value="<%=mv.getMemberNickname()%>">
               </div>
               <span id="checkNickName" class="checkText"></span>
            </div>
         </div>


         <fieldset>
            <label for="gd">MY SPECTRUM 공개범위 설정</label>
            <p>
               <input type="radio" name="gender" value="MY FRIENDS">ONLY
               MY FRIENDS <input type="radio" name="gender" value="전체공개" checked>
               전체공개 <br>
         </fieldset>

         <button type="submit" class="btn btn-secondary" onclick="update()">회원정보
            수정 완료</button>
   </form>
   </div>
   ...
   <script>
      ...
      $('#password1').on(
            ...
            function() {
               ...
               if ($('#password1').val() == "") {
                  $("#checkPass1").html('비밀번호를 입력하세요.').css('color',
                        'red');
                  return false;
               } else {
                  if (!regPass.test($('#password1').val())) {
                     $("#checkPass1").html('잘못된 형식입니다').css('color',
                           'red');
                     return false;
                  } else {
                     $("#checkPass1").html("사용가능한 비밀번호입니다.").css(
                           'color', 'white');
                  }
               }
            });
      ...
      $("#regno").on('keyup', function() {
         ...
         if ($("#regno").val() == "") {
            $("#spRegno").html("일치하지 않습니다.").css('color', 'red');

            return false;
         } else {
            if (!regno.test($("#regno").val())) {
               $("#spRegno").html('잘못된 형식입니다').css('color', 'red');
               return false;
            } else {
               $("#spRegno").html("").css('color', 'white');
            }
         }
      });
      ...
      $('#mail')
            .on(
                  ...
                  function() {
                     ...
                     if ($('#mail').val() == "") {
                        $("#checkMail").html('이메일을 입력하세요.').css(
                              'color', 'red');
                        return false;
                     } else {
                        if (!regMail.test($('#mail').val())) {
                           $("#checkMail").html('잘못된 형식입니다').css(
                                 'color', 'red');
                           return false;
                        }
                     }
                     ...
                     $.ajax({
                        ...
                        success : function(aa) {
                           if (aa.cd == "ok") {
                              $("#checkMail").html('사용할 수 없는 메일입니다.')
                                    .css('color', 'red');

                           } else {
                              $("#checkMail").html('사용가능한 메일입니다.')
                                    .css('color', 'white');
      ...
      $('#nickname').on(
            ...
            function() {
               ...
               if ($('#nickname').val() == "") {
                  $("#checkNickName").html('아이디를 입력하세요.').css('color',
                        'red');
                  return false;
               } else {
                  if (!regNickName.test($('#nickname').val())) {
                     $("#checkNickName").html('잘못된 형식입니다').css('color',
                           'red');
                     return false;
                  }
               }
               ...
               $.ajax({
                  ...
                  success : function(aa) {
                     if (aa.cd == "ok") {
                        $("#checkNickName").html('증복된 닉네임입니다.').css(
                              'color', 'red');
                     } else {
