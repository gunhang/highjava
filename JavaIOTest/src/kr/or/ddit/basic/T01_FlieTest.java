...
public static void main(String[] args) throws IOException {
	...
	/*
	 * 디렉토리(폴더)만들기
	 * 1. 변수.mkdir(); => File객체의 경로 중 마지막 위치의 디렉토리를 만든다.
	 *            => "중간의 경로가 모두 미리 만들어져 있어야 한다." 
	 * 2. 변수.mkdirs(); =>  중간에 경로가 없으면 "중간의 경로도 새롭게 만든 후" 마지막 위치의 디렉토리를 만들어준다.
	 ...
	 */
	  ...
	  if(file5.mkdir()) {
		  ...
		  System.out.println(file5.getName()+"만들기 실패!"); //처음만 성공, 중복이면 만들어지지 않아 실패뜸
	  }
	  System.out.println();
