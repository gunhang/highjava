 ...
 * -쿠키를 사용할 떄보다 보안이 향상된다.(정보가 서버에 저장되기 떄문에.,.)
 * 
 * -세션객체를 가져오는 방법
	...
	@Override
	   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	      ...
	      if (session.isNew()) {  //세션이 새로 만들어졌는지 확인...
	         title = "처음 방문을 환영합니다.";
	         session.setAttribute("userId", userId); //정보저장
	      } else {
	      ...
	      out.println("<html><head><title>"+title+"</title></head>"
	                   ...
	                   +"<table border=\"1\" align=\"center\">"+"<tr bgcolor=\"orange\">"+"<th>구분</th><th>값</th></tr>"
	       ...
	       //session.invalidate(); //세션 삭제 첫번째 방법.
